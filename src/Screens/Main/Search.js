...
export default function Search({ navigation }) {
  ...
  return (
    <View
      ...
      <View style={{ flexDirection: 'row', backgroundColor: '#fff', margin: 12, borderRadius: 124 }}>
        <Ionicons name="search" size={24} style={{ marginTop: 12, marginHorizontal: 12, backgroundColor: 'transparent' }} color="black" />
        <PhotogramTextInput
          placeholderTextColor={'#000'}
          extraStyles={{ alignSelf: "center", backgroundColor: 'transparent', borderRadius: 24, width: width - 72, marginHorizontal: 0 }}
          ...
          return (
            ...
            <TouchableOpacity activeOpacity={3} onPress={() => navigation.navigate('HomeProfile', item)} style={{ flexDirection: 'row', width: width - 124, padding: 10, backgroundColor: '#fff',borderRadius:124, width : width -24, marginVertical: 14 }}>
              <Image
                ...
                style={{ width: 50, height: 50, borderRadius: 24, marginHorizontal: 12 }}
              />
              <View>
                <PhotogramText
                  fontWeight={'h1'}
